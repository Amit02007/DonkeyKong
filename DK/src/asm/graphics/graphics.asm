...
; OUTPUT: Memory: CurrentScreen, ScreenFileName
;================================================
proc SwitchScreen
	push ax
	push bx
	...
	@@SwitchTheScreen:
		...
		@@AddBmp:
			mov [ScreenFileName + si], "."
			inc si
			mov [ScreenFileName + si], "b"
			inc si
			mov [ScreenFileName + si], "m"
			inc si
			mov [ScreenFileName + si], "p"

			@@FillZero:
				; checking if it is the last char in the 'ScreenFileName' if not, fill with zero's
				cmp si, 11 
				je @@ExitProc

				inc si
				mov [ScreenFileName + si], 0
				jmp @@FillZero
